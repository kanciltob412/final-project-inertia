            ...
            <main className="max-w-6xl mx-auto py-16 px-4">
                <section className="py-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch match-height">
                    <div className="h-full flex flex-col justify-start match-text">
                        <h2 className="text-3xl font-semibold mb-4">GIVING FORM TO AN IDEA</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">At Lavanya Ceramics we are fascinated by the possibility of being able to represent an idea with our own hands. The origin of each piece is born in our imagination as well as from the desire to listen to the demands of a constantly evolving market where creativity is an essential pillar.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">Once the idea is defined, the design team values materials, aesthetics and functionality and as of that moment, the manufacturing process begins with the fusion of old techniques together with innovative processes all based on manual work and care for detail.</p>
                    </div>
                ...
                <section className="py-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch match-height">
                    ...
                    <div className="h-full flex flex-col justify-start match-text">
                        <h3 className="text-2xl font-semibold mb-4">NOBLE MATERIALS</h3>
                        <p className="mb-4 text-gray-700 leading-relaxed">Porcelain is composed by the raw materials kaolin, feldspar and quartz. It has a high level of resistance and high density, as it is fired at 1400°C. Porcelain, stoneware and earthenware are very similar materials, and there is even a tendency for them to be confused.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">While porcelain is an impermeable material, stoneware and earthenware contain silica and clay in their composition and they easily absorb some elements to which they are exposed. Porcelain composition go through much more demanding qualitative selection criteria regarding consistency of the technical characteristics and the absence of contaminants. This unique characteristics make porcelain a pure material suitable for any event.</p>
                    </div>
                </section>

                <section className="py-12 grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch match-height">
                    <div className="h-full flex flex-col justify-start match-text">
                        <h3 className="text-2xl font-semibold mb-4">HANDMADE PROCESS</h3>
                        <p className="mb-4 text-gray-700 leading-relaxed">Our designers and modellers work together in close cooperation to construct the models. Once they have been shaped to satisfaction, they are used to make the master moulds that will be used to turn to make the negative casting moulds. After that, the items are shaped in porcelain or glass and the manufacturing process begins.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">All our fine porcelain and glass creations are crafted, fired and polished by hand with an emphasis on detail and quality.</p>
                    </div>
                    <div className="h-full overflow-hidden match-image rounded-lg">
