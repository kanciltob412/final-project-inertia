        ...
        <div>
            ...
            <main className="max-w-6xl mx-auto py-16 px-4">
                ...
                <div className="space-y-12">
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                                ...
                                <p className="text-gray-700 mb-3 leading-relaxed">Delivery within 5-7 business days</p>
                                <p className="text-gray-900 font-semibold">Free for orders over $75, otherwise $8.99</p>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                                <h3 className="text-xl font-medium mb-3">Express Shipping</h3>
                                <p className="text-gray-700 mb-3 leading-relaxed">Delivery within 2-3 business days</p>
                                <p className="text-gray-900 font-semibold">$15.99</p>
                            </div>
                            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                                <h3 className="text-xl font-medium mb-3">Overnight Shipping</h3>
                                <p className="text-gray-700 mb-3 leading-relaxed">Next business day delivery</p>
                    ...
                    <section>
                        <h2 className="text-3xl font-semibold mb-6">Processing Time</h2>
                    ...
                    <section>
                        <h2 className="text-3xl font-semibold mb-6">Shipping Locations</h2>
                        <p className="text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-3xl font-semibold mb-6">Special Care Items</h2>
                        <p className="text-gray-700 mb-4 leading-relaxed">
