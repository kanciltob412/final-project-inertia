            ...
            <div className="p-6">
                ...
                {Object.keys(errors).length > 0 && (
                    <div className="mb-6 rounded-md border border-red-200 bg-red-50 p-4">
                        <p className="mb-2 text-sm font-semibold text-red-800">Please fix the following errors:</p>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                    ...
                    {/* Discount Value */}
                    <div className="flex flex-col gap-y-2">
                        <Label htmlFor="discount_value">Discount Value {data.discount_type === 'percentage' ? '(%)' : '(Amount)'} *</Label>
                        <Input
                            id="discount_value"
                            type="number"
                            step="0.01"
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        {errors.usage_limit && <p className="text-sm text-red-600">{errors.usage_limit}</p>}
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-3 pt-6">
                        <Button type="button" variant="outline" onClick={() => (window.location.href = '/admin/coupons')} disabled={processing}>
                            Cancel
                        </Button>
