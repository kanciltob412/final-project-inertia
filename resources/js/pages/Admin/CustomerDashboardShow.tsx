...
import { ArrowLeft, DollarSign, Heart, MapPin, ShoppingBag } from 'lucide-react';
...
export default function CustomerDashboardShow({ customer, stats, recentOrders }: Props) {
    ...
    const handlePasswordReset = (e: React.FormEvent) => {
        ...
        router.post(
            `/admin/customer-dashboards/${customer.id}/reset-password`,
            {
                password,
            ...
            <div className="mx-auto max-w-7xl space-y-6 p-4 md:p-8">
                ...
                <div className="flex items-start justify-between">
                    <div>
                        <div className="mb-2 flex items-center gap-3">
                            ...
                            <h1 className="text-2xl font-bold text-gray-900 md:text-3xl lg:text-4xl">{customer.name}</h1>
                        </div>
                ...
                <div>
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600">Latest purchases from this customer</p>
                    </div>
                ...
                <div>
                    <div className="mb-4">
                        <h2 className="mb-2 text-xl font-bold text-gray-900 md:text-2xl lg:text-3xl">Change Password</h2>
                        <p className="text-sm text-gray-600">Reset customer's password - An email notification will be sent to the customer</p>
                    </div>
                    <Card>
                        <CardHeader>
                        ...
                        <CardContent>
                            <form onSubmit={handlePasswordReset} className="space-y-4">
                                {passwordError && (
                                    <div className="rounded border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-600">{passwordError}</div>
                                )}
                                ...
                                <div className="border-t pt-4">
                                    <p className="mb-3 text-sm text-gray-600">Password Requirements:</p>
