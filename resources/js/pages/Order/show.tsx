...
import { ArrowLeft, Package, Clock, MapPin, Phone, Mail, DollarSign } from 'lucide-react';
        ...
        <>
            ...
            <div className="mx-auto max-w-4xl px-4 py-8">
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div>
                        <Link href="/" className="inline-flex items-center gap-2 text-black hover:underline mb-4">
                            <ArrowLeft className="h-4 w-4" />
                            Back to Home
                        </Link>
