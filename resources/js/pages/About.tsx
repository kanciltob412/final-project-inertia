            ...
            <div className="relative h-[400px] md:h-[420px] overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center">
                    <div className="max-w-6xl w-full mx-auto px-4 transform translate-y-12 md:translate-y-16">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-semibold uppercase tracking-wide">ABOUT US</h1>
                    </div>
                </div>
            </div>

            <main className="max-w-6xl mx-auto py-8 md:py-12 lg:py-16 px-4 md:px-6 lg:px-8">
                <section className="py-8 md:py-10 lg:py-12 flex flex-col-reverse md:grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-stretch match-height">
                    <div className="h-full flex flex-col justify-start match-text w-full">
                        {/* Image on mobile, before headline */}
                        <div className="block md:hidden w-full mb-6 md:mb-0">
                        ...
                        <h2 className="text-xl md:text-2xl lg:text-3xl text-gray-900 font-semibold mb-4 md:mb-6">Brand Story</h2>
                ...
                <section className="py-8 md:py-10 lg:py-12">
                    <h3 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-6 md:mb-8">Manifesto / Our Values</h3>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                        <div className="space-y-4">
                            <img src="/images/about/our-vision-hand.jpg" alt="Vision" className="w-full h-40 object-cover rounded-lg" />
                            <h4 className="text-base md:text-lg text-gray-900 font-semibold">Our Vision</h4>
                            <p className="text-sm md:text-base text-gray-700">To build a lasting atelier that reflects the spirit of Bali — creating ceramics that embody timeless design, thoughtful craftsmanship, and a quiet sense of beauty.</p>
                        </div>

                        <div className="space-y-4">
                            <img src="/images/about/our-mission-bowl.jpg" alt="Mission" className="w-full h-40 object-cover rounded-lg" />
                            <h4 className="text-base md:text-lg text-gray-900 font-semibold">Our Mission</h4>
                            <p className="text-sm md:text-base text-gray-700">To craft pieces that enrich everyday life through authenticity and purpose. Each creation is guided by care for detail, respect for tradition, and a commitment to quality that endures. We aim to bring warmth and harmony to every table, connecting people through the simple act of sharing.</p>
                        </div>

                        <div className="space-y-4">
                            <img src="/images/about/respect-raw-materials.jpg" alt="Nature" className="w-full h-40 object-cover rounded-lg" />
                            <h4 className="text-base md:text-lg text-gray-900 font-semibold">The Respect to Nature</h4>
                            <p className="text-sm md:text-base text-gray-700">Nature is at the heart of everything we do. Our materials are of natural origin, responsibly sourced, and free from synthetic components. Each process is designed to minimize environmental impact while preserving the purity of the earth that gives our ceramics life. For us, sustainability means creating with integrity — in balance with the land, the craft, and the people who shape it.</p>
                        </div>
                    </div>
                </section>

                <section className="py-8 md:py-10 lg:py-12 flex flex-col-reverse md:flex-row items-stretch gap-6 md:gap-8 lg:gap-10 match-height">
                    <div className="flex-1 h-full flex flex-col justify-start match-text">
                        <h3 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4">Handmade</h3>
                        <p className="text-sm md:text-base text-gray-700 mb-6">Every Lavanya piece is shaped entirely by hand. From the first touch of clay to the final firing, each stage is carried out with patience and precision by our skilled artisans in Bali.
