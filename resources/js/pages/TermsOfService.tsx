            ...
            <div className="relative h-[400px] md:h-[420px] overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center">
                    <div className="max-w-6xl w-full mx-auto px-4 transform translate-y-12 md:translate-y-16">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-semibold uppercase tracking-wide">TERMS OF SERVICE</h1>
                    </div>
                </div>
            </div>

            <main className="max-w-4xl mx-auto py-8 md:py-12 lg:py-16 px-4 md:px-6 lg:px-8">
                <p className="text-sm md:text-base text-gray-600 mb-12 text-center">Last updated: November 16, 2025</p>

                <div className="space-y-12 md:space-y-14 lg:space-y-16">
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Use License</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                        ...
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">This is the grant of a license, not a transfer of title, and under this license you may not:</p>
                        <ul className="list-disc pl-6 text-sm md:text-base text-gray-700 mb-4 space-y-2">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Product Information</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Orders and Payment</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Shipping and Delivery</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Returns and Refunds</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Limitation of Liability</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Privacy Policy</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Governing Law</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Changes to Terms</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-lg md:text-xl lg:text-2xl text-gray-900 font-semibold mb-4 md:mb-6">Contact Information</h2>
                        <p className="text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
