                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-8 lg:grid-cols-4 lg:gap-12">
                    ...
                    <div className="md:pr-4 lg:pr-0">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://www.youtube.com/@LavanyaCeramics" className="text-white hover:text-gray-400">
                    ...
                    <div className="md:pl-4 lg:pl-0">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center">
                                ...
                                <a href="tel:+62811129775" className="text-white transition-colors hover:text-gray-400">
                                    +62 811-129-775
                                </a>
                            </li>
                            <li className="flex items-center">
